    ...
    jQuery.fn.bt = function (content, options) {
        ...
        return this.each(function (index) {
            ...
            this.btOn = function () {
                ...
                $(canvas).prop("width", (numb($text.btOuterWidth(true)) + opts.strokeWidth * 2 + shadowMarginX)).prop("height", (numb($text.outerHeight(true)) + opts.strokeWidth * 2 + shadowMarginY)).appendTo($box).css({
                    position: "absolute",
